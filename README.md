...
cout<<"Hotel Income:"<<setw(20)<<setprecision(2)<<fixed<<"$"<<total_amount<<endl;//setprecion is used to display the amount of place holders after the decimal point. setw is used to display the amount of spaces you want it to display//
